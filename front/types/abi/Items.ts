...
export interface Items extends BaseContract {
  constructor(
    jsonInterface: any[],
    address?: string,
  ...
  clone(): Items;
  methods: {
    GOLD(): NonPayableTransactionObject<string>;

    SHIELD(): NonPayableTransactionObject<string>;

    SILVER(): NonPayableTransactionObject<string>;

    SWORD(): NonPayableTransactionObject<string>;

    THORS_HAMMER(): NonPayableTransactionObject<string>;
